...
describe UsersController do
  ...
  describe "GET 'show'" do
    ...
    it "should be successful" do
      get :show, :id => @user #voisi myös laittaa eksplisiittisesti @user.id
      response.should be_success
    end
  ...
  describe "PUT 'update'" do
    ...
    describe "success" do
      ...
      it "should change the user's attributes" do
        put :update, :id => @user, :user => @attr
        user = assigns(:user) #:user tarkoittanee params[:user]:ia
        #jostain syystä passaa testin kun käyttää useria, vaikka
        # update_attributesia ei vielä kutsuta => käytetään @attr:ia
        @user.reload
        @user.name.should == @attr[:name]  #oli aluks ==  user.name
